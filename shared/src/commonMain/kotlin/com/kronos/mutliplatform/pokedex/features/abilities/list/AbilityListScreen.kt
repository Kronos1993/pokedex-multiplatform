...
import com.kronos.mutliplatform.pokedex.features.abilities.list.content.AbilitiesContent
...
import pokedex.shared.generated.resources.menu_abilities_search_placeholder
...
fun AbilityListScreen(
    ...
    val viewModel = koinViewModel<AbilityListScreenViewModel>()
    ...
    LaunchedEffect(listState, isLastPage, isLoading, abilities) {
        ...
        Scaffold(
            topBar = {
                AppTopAppBar(
                    ...
                    searchPlaceholder = stringResource(Res.string.menu_abilities_search_placeholder),
                    searchEnabled = true,
                    onSearchQueryChange = {
