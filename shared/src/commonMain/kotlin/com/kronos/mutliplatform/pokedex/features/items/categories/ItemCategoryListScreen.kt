...
import com.kronos.mutliplatform.pokedex.features.items.categories.content.ItemCategoriesContent
...
@Composable
fun ItemCategoryListScreen(
    navHost: NavHostController,
    isDarkTheme: Boolean,
    deviceScreenConfiguration: DeviceScreenConfiguration,
) {
    val viewModel = koinViewModel<ItemCategoryListScreenViewModel>()
    val appViewModel = koinViewModel<AppViewModel>()

    val itemCategories by viewModel.itemCategory.collectAsStateWithLifecycle()
    ...
    LaunchedEffect(listState, isLastPage, isLoading, itemCategories) {
        ...
        NavDrawer(
            ...
            Scaffold(
                ...
                PullToRefreshContainer(
                    ...
                    onRefresh = { viewModel.refreshItems(true) }
                ) {
                    ...
                    if (itemCategories.isEmpty()) {
                        ...
                        ItemCategoriesContent(
                            ...
                            onClick = { itemCategory ->
                                navHost.navigate("${Destinations.ITEMS.name}/${itemCategory.name}")
                            },
                            modifier = rootModifier
                        )
                    }
