...
import pokedex.shared.generated.resources.menu_nature_search_placeholder
...
fun NatureListScreen(
    ...
    LaunchedEffect(listState, isLastPage, isLoading, natures) {
        ...
        Scaffold(
            topBar = {
                AppTopAppBar(
                    ...
                    searchPlaceholder = stringResource(Res.string.menu_nature_search_placeholder),
                    searchEnabled = true,
                    onSearchQueryChange = {
            ...
            PullToRefreshContainer(
                ...
                if (natures.isEmpty()) {
                    ...
                    NaturesContent(
                        ...
                        moves = natures,
                        onClick = {
                            navHost.navigate("${Destinations.NATURE_DETAIL.name}/${it.name}")
                        },
                        modifier = rootModifier
                    )
                }
