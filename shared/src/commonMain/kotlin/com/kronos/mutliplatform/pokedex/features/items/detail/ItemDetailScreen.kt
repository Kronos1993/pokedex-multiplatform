...
import com.kronos.mutliplatform.pokedex.features.items.detail.content.ItemInfoScreen
...
fun ItemDetailScreen(
    ...
    val viewModel = koinViewModel<ItemDetailScreenViewModel>()
    val itemInfo by viewModel.item.collectAsStateWithLifecycle()
    ...
    val screenTitle = remember(itemInfo, currentLang) {
        itemInfo.getName(currentLang)
