...
import com.kronos.mutliplatform.pokedex.features.berries.detail.content.BerryInfoScreen
...
fun BerryDetailScreen(
    ...
    val viewModel = koinViewModel<BerryDetailScreenViewModel>()
    val berryInfo by viewModel.berryInfo.collectAsStateWithLifecycle()
    ...
    LaunchedEffect(berry) {
        viewModel.loadBerryInfo(berry)
    }
    ...
    val screenTitle = remember(berryInfo, currentLang) {
        berryInfo.getName(currentLang)
        ...
        Scaffold(
            ...
            PullToRefreshContainer(
                ...
                BerryInfoScreen(
                    ...
                    onSeeMoreClick = {
                        navHost.navigate("${Destinations.ITEM_DETAIL.name}/${it}")
                    }
                )
            }
