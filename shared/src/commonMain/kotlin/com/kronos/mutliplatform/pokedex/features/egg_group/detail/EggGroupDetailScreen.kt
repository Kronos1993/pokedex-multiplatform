...
import com.kronos.mutliplatform.pokedex.features.egg_group.detail.content.EggGroupInfoScreen
...
fun EggGroupDetailScreen(
    ...
    val viewModel = koinViewModel<EggGroupDetailScreenViewModel>()
    val eggGroupInfo by viewModel.eggGroupInfo.collectAsStateWithLifecycle()
    ...
    LaunchedEffect(eggGroup) {
        viewModel.loadEggGroupInfo(eggGroup)
    }
    ...
    val screenTitle = remember(eggGroupInfo, currentLang) {
        eggGroupInfo.getName(currentLang)
