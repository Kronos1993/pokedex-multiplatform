package com.kronos.mutliplatform.pokedex.features.berries.list.content
...
fun BerryItemCard(
    ...
    icon: ImageVector = Icons.Berries,
...
@Composable
fun BerryItemCardPreview() {
    AppTheme() {
        BerryItemCard(
            item = NamedResourceApi("berry",""),
            onClick = {}
        )
    }
}
