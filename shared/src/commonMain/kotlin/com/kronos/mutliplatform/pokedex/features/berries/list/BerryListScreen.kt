...
import com.kronos.mutliplatform.pokedex.features.berries.list.content.BerriesContent
...
fun BerryListScreen(
    ...
    val viewModel = koinViewModel<BerryListScreenViewModel>()
    val appViewModel = koinViewModel<AppViewModel>()

    val berries by viewModel.berries.collectAsStateWithLifecycle()
    ...
    LaunchedEffect(listState, isLastPage, isLoading, berries) {
                ...
                PullToRefreshContainer(
                    ...
                    if (berries.isEmpty()) {
                        ...
                        BerriesContent(
                            ...
                            berries = berries,
                            onClick = {
                                navHost.navigate("${Destinations.BERRY_DETAIL.name}/${it.name}")
                            },
                            modifier = rootModifier
                        )
                    }
