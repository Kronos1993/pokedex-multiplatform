...
import com.kronos.mutliplatform.pokedex.features.natures.detail.content.NatureInfoCard
...
fun NatureDetailScreen(
    ...
    val viewModel = koinViewModel<NatureDetailScreenViewModel>()
    val natureInfo by viewModel.natureInfo.collectAsStateWithLifecycle()
    ...
    LaunchedEffect(nature) {
        viewModel.loadNatureInfo(nature)
    }
    ...
    val screenTitle = remember(natureInfo, currentLang) {
        natureInfo.getName(currentLang)
