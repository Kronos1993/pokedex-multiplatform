package com.kronos.mutliplatform.pokedex.features.abilities.list.content
...
@Composable
fun AbilitiesContent(
    listState: LazyGridState,
    gridColumns: Int = 1,
    abilities: List<NamedResourceApi>,
    ...
    Column(
        ...
        LazyVerticalGrid(
            ...
            items(abilities, key = { it.name }) {
                AbilityItemCard(it, onClick = {
                    onClick(it)
                })
            }
